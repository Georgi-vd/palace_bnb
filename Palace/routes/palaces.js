...
const { palaces } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('palaces');

// This file contains the logic of every route in Forest Admin for the collection palaces:
...
// Create a Palace
router.post('/palaces', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Palace
router.put('/palaces/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Palace
router.delete('/palaces/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Palaces
router.get('/palaces', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Palaces
router.get('/palaces/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Palace
router.get('/palaces/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Palaces
router.get('/palaces.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
